...
headers=device.DICT__Register_HEADERS
...
#--------------------------------------------------------
def test_query_crop_price(ids,token,phone,time):
    datalist=my_obj.query_crop_price(ids,token,phone,time)
    print(datalist)
...
#--------------------------------------------------------
def test_add_reserve_order(ids,token,phone,carid,planeid,price1,time1):
    
    datalist=my_obj.fsd_add_reserve_order(ids,token,phone,carid,planeid,price1,time1)
    print(datalist)
    if datalist[0]!=1:
        print('Fail')  
...
if __name__ == "__main__" :
    ...
    #time=[1525881600]  
    re=test_query_crop_price(ids,token,phone,time1)
    print(re)
    ...
    re=test_add_reserve_order(ids,token,phone,carid,planeid,price1,time1)
